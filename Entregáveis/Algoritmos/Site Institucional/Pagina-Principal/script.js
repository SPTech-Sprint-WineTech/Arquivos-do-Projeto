...
contaLinhas++;
      ...
      document.getElementById(`text32`).blur()
		...
		focus32();
      document.getElementById(`text32`).blur()
		text27.innerHTML += "Aí você pensa, que tal investir uns R$" + custoCorrigido + " num projeto top da WineTech";
      ...
      document.getElementById(`text32`).blur()
		...
		focus32();
      document.getElementById(`text32`).blur()
		text29.innerHTML += "Com esse investimento, você recupera em uns " + tempoAmortizacao + " anos.";
		text29.classList.add("textLine");
	}, 10000);
		setTimeout(() => {
		focus32();
      document.getElementById(`text32`).blur()
		text30.innerHTML += "Depois disso, você só fica com a manutenção, que sai por volta de R$" + manutencaoCorrigida;
...
contaLinhas = 1;
	...
	function chamaModal() {
		...
		setTimeout(() => {
			...
			imagemGarrafa.style =
				"animation: 1s linear 0s 1 normal both growbottle1;";
		}, 10);
	...
	function fechaModal() {
		...
		setTimeout(() => {
			...
			imagemGarrafa.style =
				"animation: 1s linear 0s 1 normal both growbottle2;";
		}, 10);
